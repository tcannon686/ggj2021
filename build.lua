----------------------------------------------------------------------------------------------------------------
--
-- groverburger's love2d game build script for posix systems
...
local dir = date
local game = "clueless" -- change this to the name of your game
local loveVersion = 11.3 -- keep this up to date with the latest version of love
